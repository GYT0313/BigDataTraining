...
public class Validation {
    ...
    public static boolean isCAPTURETIME(String str) {
        return Regular(str, CAPTURETIME);
    }
    ...
    public static boolean isAUTH_TYPE(String str) {
        return Regular(str, CAPTURETIME);
    }
    ...
    public static boolean isFIRM_CODE(String str) {
        return Regular(str, FIRM_CODE);
    }
