...
package com.cn.gp.es.jest.service;
...
public class JestService {
     ...
     * @date 2020/2/26
     */
    public static SearchResult search(JestClient jestClient, String indexName, String typeName,
        ...
        if (StringUtils.isEmpty(field)) {
            ...
            boolQueryBuilder.must(QueryBuilders.termQuery(field, fieldValue));
        }
...
//        System.out.println(searchSourceBuilder.toString());
    ...
    public static SearchResult search(JestClient jestClient, String indexName, String typeName,
                                      String field, String fieldValue,
                                      String sortField, String sortValue,
                                      int pageNumber, int pageSize, String[] includes) {
        // 构造一个查询体, 封装的是查询语句
        SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder();
...
//        System.out.println(searchSourceBuilder.toString());
    ...
    public static void main(String[] args) throws Exception {
        ...
        SearchResult search = search(jestClient, "", "",
                "phone_mac.keyword", "aa-aa-aa-aa-aa-aa",
                "collect_time", "asc",
                1, 1000);
